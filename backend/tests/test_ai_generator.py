...
class TestAIGenerator(unittest.TestCase):
    ...
    def test_sequential_tool_execution_flow(self, mock_anthropic):
        ...
        mock_final_response.content[0].text = (
            "Based on the course outline and content search, here are the retrieval techniques..."
        )
        ...
        mock_tool_manager.execute_tool.assert_called_once_with(
            "get_course_outline", course_name="RAG Course"
        )
    ...
    def test_error_handling_in_tool_execution(self):
        ...
        failing_tool_manager.execute_tool.side_effect = Exception(
    ...
    def test_complex_multi_step_scenario(self, mock_anthropic):
        ...
        mock_final_response.content = [MagicMock()]
        mock_final_response.content[0].text = (
            "Based on lesson 4 of Machine Learning Course (Neural Networks), I found the Deep Learning Specialization course that covers similar topics..."
        )
