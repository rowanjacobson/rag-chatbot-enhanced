...
def run_tests_with_detailed_output():
    ...
    for module_name, module_results in results.items():
        ...
        print(f"{module_name:30} {status:10} Tests:{module_results['tests_run']:3} Failures:{module_results['failures']:2} Errors:{module_results['errors']:2}")
    ...
    print(f"  Tests:   {total_tests - total_failures - total_errors}/{total_tests} passed")
